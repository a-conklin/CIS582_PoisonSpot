...
def get_ht_stl10_poisoned_data(
    ...
    """
    Generate and return poisoned SLT-10 dataset with a hidden trigger backdoor.
...
def get_ht_imagenet_poisoned_data(
    ...
    """
    Generate and return poisoned Image-Net dataset with a hidden trigger backdoor.
